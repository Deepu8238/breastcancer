...
def cleaned_data():
    data=pd.read_csv('data/data.csv')# Placeholder for the actual implementation
...
def add_sidebar():
    ...
    slider_labels=[
        ...
        ("Symmerty (mean)","symmetry_mean"),
        ("Fractal Dimensions (mean)","fractal_dimension_mean"),
        ("Radius (se)","radius_se"),
...
def add_predictions(input_data):
    ...
    st.write("This app can assist medical professionals in making a diagnosis, should not be used as a substitute for a professional diagnosis.")

def main():
    st.set_page_config(
        page_title="Breast Cancer Predictions",
        page_icon="🧬",
        layout="wide",
    ...
    with st.container():
        ...
        st.write("Please Connect this app to your cytology lab to help diagnose Breast Cancer from the tissue sample. This app predicts using a machine learning model wheather a breast mass is benign or malignant based on the measurements it recieves from your cytosis lab. You can also update the measurements by hand using the sliders in the sidebar.")
